...
- символ NUL (`\u0000`) недопустим, поскольку PostgreSQL не поддерживает его в строковых типах;
...
Невалидный запрос, включая имя с символом NUL, не создаёт запись в PostgreSQL.
